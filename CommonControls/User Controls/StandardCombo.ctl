...
Begin VB.UserControl StandardCombo 
   ClientHeight    =   495
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   2055
   ...
   ScaleHeight     =   495
   ScaleWidth      =   2055
   ToolboxBitmap   =   "StandardCombo.ctx":0000
   ...
   End
End
Attribute VB_Name = "StandardCombo"
...
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
'Citex Software                                                       '
'XP GUI Toolkit v1.0 - StandardCombo Component v1.0                        '
...
Attribute DrawMode.VB_Description = "Returns/sets the way the combobox is drawn."
    DrawMode = m_DrawMode
End Property
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    cmbMain.FullRowSelect = PropBag.ReadProperty("FullRowSelect", True)
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    Call PropBag.WriteProperty("FullRowSelect", cmbMain.FullRowSelect, True)
