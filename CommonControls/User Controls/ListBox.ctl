...
Begin VB.UserControl StandardList 
   BackColor       =   &H00FFFFFF&
   ClientHeight    =   2775
   ClientLeft      =   0
   ClientTop       =   0
   ...
   ScaleHeight     =   2775
   ScaleWidth      =   4170
   ToolboxBitmap   =   "ListBox.ctx":0000
   ...
   End
End
Attribute VB_Name = "StandardList"
...
Attribute Columns.VB_Description = "Returns/sets the number of columns shown in a list box or combo box."
...
Attribute FullRowSelect.VB_Description = "Returns/sets whether a selection in a list will cover the entire row or just highlight the selected item's text."
...
Attribute Locked.VB_Description = "Returns/sets whether the listbox is locked."
    Locked = m_Locked
End Property
...
Attribute DefaultStyle.VB_Description = "Returns/sets whether the listbox is automatically setup in a common style."
...
Attribute DrawMode.VB_Description = "Returns/sets the way the listbox is drawn."
    DrawMode = m_DrawMode
End Property
...
Private Sub Left_Paint()
'pSetBorder
End Sub

Private Sub Right_Paint()
'pSetBorder
End Sub

Private Sub Top_Paint()
'pSetBorder
End Sub
